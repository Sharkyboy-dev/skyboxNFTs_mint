    ...
    >
      ...
      >
        ...
        <p>
          ...
          information. This Privacy Policy outlines how we collect, use, and protect the data you share when
        ...
        <p>We do <strong>not</strong> sell, trade, or rent your data to third parties. However, we may share anonymized or aggregated data with service providers for analytics and performance optimization.</p>
        <p>Blockchain transactions are public and permanently recorded. Your wallet address and transaction history may be visible to others via the Solana blockchain.</p>

        <h2>4. Data Security</h2>
        <p>We implement reasonable technical and organizational measures to protect user data. Wallet integrations are handled via secure and vetted providers (e.g., Phantom). All NFT transactions occur directly on the Solana blockchain.</p>

        <h2>5. Third-Party Services</h2>
        <p>Our website may include links to third-party platforms (e.g., Magic Eden, Solscan). We are not responsible for the privacy practices of these services.</p>

        <h2>6. Your Rights</h2>
        <p>You have the right to disconnect your wallet at any time. You may also request that we remove any on-site data related to your session history by contacting us at: 📧 <a href="mailto:dev@sharkyboy.com" style={{ color: "#0ff" }}>dev@sharkyboy.com</a></p>

        <h2>7. Children's Privacy</h2>
        <p>SharkyBoy NFTs is not intended for use by individuals under the age of 18. We do not knowingly collect data from minors.</p>
        ...
        <h2>Contact Us</h2>
        <p>For any questions about this Privacy Policy or your data rights, contact us at: 📧 <a href="mailto:dev@sharkyboy.com" style={{ color: "#0ff" }}>dev@sharkyboy.com</a></p>
      </div>
    </div>
  );
};
